...
const initialState = {
    ...
    categories: { value: 'business/business', label: 'Business' },
    newsCategory: [{ value: 'business/business', label: 'Business' }, { value: 'entertainment/entertainment', label: 'Entertainment' }, { value: 'general/general', label: 'General' }, { value: 'health/health', label: 'Health' }, { value: 'science/science', label: 'Science' }, { value: 'sports/sports', label: 'Sports' }, { value: 'technology/technology', label: 'Technology' }],
